...
function group7_animation() {
    ...
    var transX = [50, 0, 0, 90, 30];
    var transY = [10, 0, 120, 200, 230];
    var init_scale = [1/2, 1/20, 1/2, 1/10, 1/2];
    var init_rotate = [-60, 0, -50, 0, 50];
    var duration = [3000, 1800, 3000, 1800, 3000];
    
    timeline.add({
        targets: ['#Group-41', '#Fill-49', '#Group-43', '#Group-48', '#Group-44'],
        translateX: 160,
        translateY: 250,
    ...
    var init_transX2 = [50, 0, 0, 90, 30];
    var init_transY2 = [10, 0, 120, 200, 230];
    var scale = [1/2, 1/10, 1/2, 1/10, 1/2];
    var rotate = [-60, 0, -50, 0, 50];
    var duration = [2500, 3000, 2500, 3000, 2500];
